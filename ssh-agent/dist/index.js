...
try {
    ...
    const knownHostsFilePath = `${homeSsh}/known_hosts`

    console.log(`Adding GitHub.com keys to ${knownHostsFilePath}`);
    ...
    core.setOutput("known-hosts-file-path", knownHostsFilePath);
    ...
    console.log("Private keys added:");
